...
void loop() {
 ...
 delay(2000);
    Sending_To_phpmyadmindatabase_device1(); 
 }
...
void Sending_To_phpmyadmindatabase_device1()
{
  ...
  if (client.connect(server1, 80)) {
   ...
   // Make a HTTP request:
    Serial.print("GET /fishermantracker/tracker.php?userIP=");
    client.print("GET /fishermantracker/tracker.php?userIP=");     //YOUR URL
